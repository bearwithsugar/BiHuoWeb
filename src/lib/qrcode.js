...
var dark = false; if (byteIndex < data.length) { dark = (((data[byteIndex] >>> bitIndex) & 1) == 1)}
 ...
 if (buffer.getLengthInBits() >= totalDataCount * 8) { break}
      ...
      return QRCodeModel.createBytes(buffer, rsBlocks)}; QRCodeModel.createBytes = function (buffer, rsBlocks) { 
...
if (col + c < 0 || moduleCount <= col + c) { continue}
      ...
      var ratio = Math.abs(100 * darkCount / moduleCount / moduleCount - 50) / 5; lostPoint += ratio * 10; return lostPoint}}; var QRMath = {glog: function (n) { 
